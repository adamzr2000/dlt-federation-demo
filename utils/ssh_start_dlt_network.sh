...
NODE_1_COMMAND="cd /home/${NODE_1_USER}/dlt-federation-demo/dlt-network/ && ./start_dlt_network.sh"
NODE_2_COMMAND="cd /home/${NODE_2_USER}/dlt-federation-demo/dlt-network/ && ./join_dlt_network.sh --node node2 --validators 2"
